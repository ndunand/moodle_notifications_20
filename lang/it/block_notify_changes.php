<?php
$string['pluginname'] = 'Notifica Cambiamenti';
...
$string['email_icon_tooltip'] = 'Le modifiche al corso verranno notificate via e-mail.';
$string['sms_icon_tooltip'] = 'Le modifiche al corso verranno notificate via SMS.';
...
$string['rss_icon_tooltip'] = 'Le modifiche al corso verranno notificate via RSS';
$string['email'] = 'e-mail';
$string['sms'] = 'SMS';
$string['rss'] = 'RSS';
$string['notification_frequency'] = 'Frequenza di notifica in ore:';
$string['notification_frequency_comment'] = 'La notifica verr&agrave; eseguita ogni numero di ore scelto.';
